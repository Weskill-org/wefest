...
## Corpus Check
- 209 files · ~135,617 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 990 nodes · 2766 edges · 79 communities (60 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ccbb481d`
...
- `PaymentDialog()` --calls--> `coinsToInr()`  [EXTRACTED]
  C:/Users/ppdub/Documents/Official Work/Weskill/WeFest/git/wefest/src/components/wallet/payment-dialog.tsx → src/lib/wallet.functions.ts
...
Cohesion: 0.07
Nodes (38): QRScanner(), QRScannerProps, sponsorshipTiers, Proposal, ALL_TAGS, EditEvent(), normalizeMembers(), OrganizerEventDashboard() (+30 more)

### Community 2 - "Event & College Cards"
Cohesion: 0.05
Nodes (56): useWallet(), useWalletTransactions(), loadRazorpayScript(), OpenCheckoutOptions, openRazorpayCheckout(), Window, createWalletTopupOrder, getRazorpayKeyId (+48 more)
...
Cohesion: 0.14
Nodes (19): Product, ProductCard(), Currency, RegionContext, RegionContextType, useRegion(), AdminDashboard(), Route (+11 more)

### Community 6 - "Region & Global State"
Cohesion: 0.12
Nodes (7): College, AdminCompanies(), LoginSearch, SafetyPoint(), TalentMarketplace(), Button, Input

### Community 7 - "Organizer Dashboard"
Cohesion: 0.11
Nodes (15): cn(), DashboardStatTile(), DashboardStatTileProps, CompanyProposals(), QuickActionBtn(), RoleBadge(), RoleDetail(), Checkbox (+7 more)
...
Cohesion: 0.13
Nodes (9): AdminAdmins(), Rank, RANKS, CollegeProfilePage(), gradientPalette, hashGradient(), Badge(), BadgeProps (+1 more)
...
Cohesion: 0.15
Nodes (9): ActivityFeedPopover(), ActivityFeedPopoverProps, actions, QuickAction, QuickActionsProps, Route, navLinks, StudentLayout() (+1 more)

### Community 17 - "Table Components"
Cohesion: 0.21
Nodes (9): AdBanner(), AdBannerProps, Event, EventCard(), categories, Feature(), Home(), Route (+1 more)
...
Cohesion: 0.27
Nodes (5): Activity, iconMap, RecentActivity(), attachSupabaseAuth, supabase
...
- **Why does `cn()` connect `Organizer Dashboard` to `Forms & User Interface`, `Event & College Cards`, `Supabase & Auth`, `Sidebar & Layout`, `Admin Management`, `Region & Global State`, `Stat Tiles & Pagination`, `UI Primitives`, `Carousel Components`, `Command Palette`, `Context Menus`, `Alert Dialogs`, `Blog & Content`, `Student Dashboard`, `Breadcrumbs`, `Navigation Menus`, `Toggles & Buttons`, `Card Layouts`, `Quick Actions`, `Alert Components`, `OTP Input`, `Admin Layout`, `Scripts & Utilities`, `Refund Policy`, `College Directory`, `Cookie Policy`, `Privacy Policy`, `Performance Snapshot`, `WeFest Vision & Model`, `ESLint Config`, `Vite Config`, `Pass System`?**
  _High betweenness centrality (0.265) - this node is a cross-community bridge._
- **Why does `Button` connect `Region & Global State` to `Forms & User Interface`, `Event & College Cards`, `Supabase & Auth`, `Sidebar & Layout`, `Admin Management`, `Terms & Conditions`, `Performance Snapshot`, `Stat Tiles & Pagination`, `UI Primitives`, `Carousel Components`, `Event Lifecycle`, `Context Menus`, `Table Components`, `Blog & Content`, `Navigation Menus`, `OTP Input`, `Student Layout`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `supabase` connect `OTP Input` to `Forms & User Interface`, `Event & College Cards`, `Sidebar & Layout`, `Admin Management`, `Region & Global State`, `Performance Snapshot`, `Stat Tiles & Pagination`, `UI Primitives`, `Collapsible UI`, `Carousel Components`, `Alert Dialogs`, `Table Components`, `Community 50`, `Navigation Menus`, `Student Layout`?**
