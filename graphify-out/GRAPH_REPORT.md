# Graph Report - wefest  (2026-05-20)

## Corpus Check
- 262 files · ~258,571 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1080 nodes · 2292 edges · 79 communities (58 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4116bb6e`
...
Cohesion: 0.01
Nodes (139): Route, Route, Route, Route, Route, Route, Route, Route (+131 more)

### Community 1 - "Forms & User Interface"
Cohesion: 0.05
Nodes (52): QRScanner(), QRScannerProps, EventsHeroProps, ShareEventDialogProps, capacityToDb(), formatSlug(), generateEventSlug(), CapacityField() (+44 more)
...
Cohesion: 0.06
Nodes (31): AuthSession, canAccessOrganizerPortal(), getAuthSession(), getSupabaseAuthHeaders(), UserRole, OrganizerHeaderProps, adminLinks, Route (+23 more)
...
Cohesion: 0.1
Nodes (19): CertificateProps, CertificateTemplate(), Route, CompanyProposals(), Proposal, Route, Route, Route (+11 more)
...
Cohesion: 0.11
Nodes (22): cn(), DashboardStatTile(), DashboardStatTileProps, CompanyMessages(), NewEvent(), Signup(), MemoriesPage(), Route (+14 more)
...
Cohesion: 0.14
Nodes (16): EmptyState(), EmptyStateProps, StudentAppLayout(), StudentAppLayoutProps, ensureStudentProfileRow(), getReferralCodeFromUser(), markReferralProcessed(), processReferralAfterLogin() (+8 more)
...
Cohesion: 0.13
Nodes (14): inviteTeamMember, inviteTeamMemberInput, requireSupabaseAuth, supabaseAdmin, CompositeTypes, Constants, Database, DatabaseWithoutInternals (+6 more)
...
Cohesion: 0.16
Nodes (9): ActivityFeedPopover(), ActivityFeedPopoverProps, Activity, iconMap, RecentActivity(), RecentActivityData, Route, Route (+1 more)
...
Cohesion: 0.27
Nodes (9): ShareEventDialog(), capacityFromDb(), formatEventCapacity(), isUnlimitedEventCapacity(), PublicEventDetail(), Route, FullEventDetail(), Route (+1 more)

### Community 24 - "Card Layouts"
Cohesion: 0.23
Nodes (7): useWalletTransactions(), Route, Route, Route, RedeemGiftCardDialog(), TYPE_LABEL, WalletPanel()
...
Cohesion: 0.24
Nodes (5): BLOG_POSTS, BlogPost, Route, Route, Route

### Community 27 - "OTP Input"
Cohesion: 0.18
Nodes (5): ADJECTIVES, NOUNS, parseSlug(), EditEvent(), normalizeMembers()
...
Cohesion: 0.24
Nodes (8): Event, EventCard(), Currency, RegionContext, RegionContextType, RegionProvider(), useRegion(), AdminDashboard()

### Community 31 - "Refund Policy"
Cohesion: 0.31
Nodes (8): useWallet(), coinsToInr(), getMyWallet, getMyWalletTransactions, PaymentDialog(), PaymentDialogProps, PurchaseIntent, WalletTopupDialog()
...
## Knowledge Gaps
- **459 isolated node(s):** `supabase`, `supabase`, `Register`, `TermsRoute`, `TalentRoute` (+454 more)
...
- **Why does `cn()` connect `Stat Tiles & Pagination` to `Forms & User Interface`, `Event & College Cards`, `Supabase & Auth`, `Sidebar & Layout`, `Region & Global State`, `Organizer Dashboard`, `UI Primitives`, `Carousel Components`, `Charting & Data Viz`, `Command Palette`, `Table Components`, `Student Dashboard`, `Drawer Components`, `Navigation Menus`, `Toggles & Buttons`, `Card Layouts`, `Quick Actions`, `Admin Layout`, `Student Layout`, `Refund Policy`, `College Directory`, `Cookie Policy`, `Privacy Policy`, `Terms & Conditions`, `Blog System`, `ESLint Config`, `Collapsible UI`, `Event Lifecycle`, `Sponsor Matching`?**
  _High betweenness centrality (0.194) - this node is a cross-community bridge._
- **Why does `Button` connect `Forms & User Interface` to `Event & College Cards`, `Supabase & Auth`, `Sidebar & Layout`, `Region & Global State`, `Organizer Dashboard`, `Stat Tiles & Pagination`, `UI Primitives`, `Carousel Components`, `Charting & Data Viz`, `Student Dashboard`, `Drawer Components`, `Toggles & Buttons`, `Card Layouts`, `Alert Components`, `Scripts & Utilities`, `Cookie Policy`, `Performance Snapshot`, `Student Events`, `WeFest Vision & Model`, `ESLint Config`, `Aspect Ratio UI`, `Sponsor Matching`, `Community 48`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `supabase` connect `Forms & User Interface` to `Event & College Cards`, `Supabase & Auth`, `Region & Global State`, `Organizer Dashboard`, `Stat Tiles & Pagination`, `UI Primitives`, `Charting & Data Viz`, `Blog & Content`, `Student Dashboard`, `Toggles & Buttons`, `Card Layouts`, `Alert Components`, `Refund Policy`, `Cookie Policy`, `Performance Snapshot`, `Student Events`, `ESLint Config`, `Vite Config`, `Aspect Ratio UI`, `QR Ticketing`, `Sponsor Matching`, `Community 49`, `Community 57`, `Community 59`, `Community 65`?**
