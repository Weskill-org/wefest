...
## Corpus Check
- 290 files · ~1,222,392 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1382 nodes · 2588 edges · 102 communities (81 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7edcbb80`
...
Cohesion: 0.05
Nodes (42): AdBanner(), Event, EventCard(), Product, ProductCard(), Currency, RegionContext, RegionContextType (+34 more)

### Community 2 - "Event & College Cards"
Cohesion: 0.05
Nodes (38): LoadingScreen(), ActivityFeedPopover(), ActivityFeedPopoverProps, marketingNav, SiteFooter(), SiteHeader(), AuthSession, canAccessOrganizerPortal() (+30 more)
...
Cohesion: 0.1
Nodes (11): AdBannerProps, EventsHeroProps, College, Route, Route, categories, LoginSearch, Route (+3 more)
...
Cohesion: 0.12
Nodes (20): ShareEventDialogProps, loadRazorpayScript(), OpenCheckoutOptions, openRazorpayCheckout(), Window, Route, Route, sponsorshipTiers (+12 more)

### Community 9 - "UI Primitives"
Cohesion: 0.12
Nodes (18): QRScanner(), QRScannerProps, LogEntry, Role, roles, Route, Signup(), SignupSearch (+10 more)

### Community 10 - "Menubar & Toolbars"
Cohesion: 0.11
Nodes (21): OrganizerHeaderProps, BoothVisit, COLORS, CompanyDashboard(), KpiCard(), Proposal, Route, ChatPartner (+13 more)

### Community 11 - "Carousel Components"
Cohesion: 0.12
Nodes (11): Rank, RANKS, sponsorshipTiers, InviteDialog(), roleLabel(), Badge(), BadgeProps, badgeVariants (+3 more)

### Community 12 - "Form Controls"
Cohesion: 0.11
Nodes (22): cn(), DashboardStatTile(), DashboardStatTileProps, InviteAcceptPage(), InviteSearch, Route, MemoriesPage(), Route (+14 more)
...
Cohesion: 0.19
Nodes (11): CapacityFieldProps, Coupon, Switch, Table, TableBody, TableCaption, TableCell, TableFooter (+3 more)
...
Cohesion: 0.15
Nodes (9): BLOG_POSTS, BlogPost, Route, Route, Route, duplicates, existing, proposed (+1 more)
...
## Knowledge Gaps
- **688 isolated node(s):** `supabase`, `content`, `existingSlugs`, `files`, `batchFiles` (+683 more)
...
- **Why does `cn()` connect `Form Controls` to `Forms & User Interface`, `Event & College Cards`, `Supabase & Auth`, `Sidebar & Layout`, `Admin Management`, `Organizer Dashboard`, `Stat Tiles & Pagination`, `UI Primitives`, `Menubar & Toolbars`, `Carousel Components`, `Command Palette`, `Alert Dialogs`, `Blog & Content`, `Student Dashboard`, `Breadcrumbs`, `Navigation Menus`, `Toggles & Buttons`, `QR Ticketing`, `Sponsor Matching`, `Community 48`, `Community 49`, `Community 54`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 62`, `Community 63`, `Community 65`, `Community 67`, `Community 68`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `Button` connect `Sidebar & Layout` to `Forms & User Interface`, `Event & College Cards`, `Supabase & Auth`, `Admin Management`, `Organizer Dashboard`, `Stat Tiles & Pagination`, `UI Primitives`, `Menubar & Toolbars`, `Carousel Components`, `Form Controls`, `Command Palette`, `Blog & Content`, `Student Dashboard`, `Drawer Components`, `Navigation Menus`, `Toggles & Buttons`, `Community 54`, `Community 56`, `Community 60`, `Community 65`, `Community 66`, `Community 70`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `supabase` connect `Sidebar & Layout` to `Forms & User Interface`, `Event & College Cards`, `Supabase & Auth`, `Organizer Dashboard`, `Stat Tiles & Pagination`, `UI Primitives`, `Menubar & Toolbars`, `Carousel Components`, `Form Controls`, `Blog & Content`, `Student Dashboard`, `Drawer Components`, `Navigation Menus`, `Community 54`, `Community 56`, `Community 60`, `Community 65`, `Community 66`, `Community 71`, `Community 72`, `Community 77`, `Community 78`, `Community 89`?**
