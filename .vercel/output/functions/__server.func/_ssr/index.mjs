...
import { C as parseRedirect, z as mergeHeaders, v as isRedirect, F as resolveManifestAssetLink, G as rootRouteId, o as getNormalizedURL, p as getOrigin, b as attachRouterServerSsrUtils, i as defineHandlerCallback, f as createSerializationAdapter, e as createRawStreamRPCPlugin, r as invariant, u as isNotFound, w as isResolvedRedirect, l as executeRewriteInput, h as defaultSerovalPlugins, y as makeSerovalPlugin } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BLdTuPgL.mjs");
...
const manifest = {
  "350f5a32c4d4e75fb92a5d3e86f1d4a377b70a50e7167b6228da6903c9665510": {
    functionName: "getMyWallet_createServerFn_handler",
    importer: () => import("./wallet.functions-D5-Ga8us.mjs")
  },
  "33b36e30b6bb7dc5322b6aa43077176bf5956dc60458ccd34e2c31f427e79b56": {
    functionName: "getMyWalletTransactions_createServerFn_handler",
    importer: () => import("./wallet.functions-D5-Ga8us.mjs")
  },
  "8abaf323b8cc05a6685d69ca5d7255d2d41790f0ca6f2660080f814696053f09": {
    functionName: "payForTicketWithWallet_createServerFn_handler",
    importer: () => import("./wallet.functions-D5-Ga8us.mjs")
  },
  "cced05aa6cdc7624d9d305a17b6f3e85857f2c999a6034ac2dbb3227d5aed381": {
    functionName: "payForProductWithWallet_createServerFn_handler",
    importer: () => import("./wallet.functions-D5-Ga8us.mjs")
  },
  "de213bb2a3b807d91bd13cf31987248e6b93eb4de42de7ffbc0a69443aadaddd": {
    functionName: "sponsorEventWithWallet_createServerFn_handler",
    importer: () => import("./wallet.functions-D5-Ga8us.mjs")
  },
  "36025196498f272e4529bd0ce3f249f1edd4e6399467f6fdd4207731f59573f9": {
    functionName: "requestWithdrawal_createServerFn_handler",
    importer: () => import("./wallet.functions-D5-Ga8us.mjs")
  },
  "6bc3d9a2e3696c49c50acee525e610576f929b6d9d0231942e8ec9dd3854780e": {
    functionName: "getMyWithdrawals_createServerFn_handler",
    importer: () => import("./wallet.functions-D5-Ga8us.mjs")
  },
  "5a29c5caa99ba8439e6e4d9e309722da2fe60dba2d7da3e5bc90f797600b3546": {
    functionName: "redeemGiftCard_createServerFn_handler",
    importer: () => import("./wallet.functions-D5-Ga8us.mjs")
  },
  "d620d153cd9e36c1ac0605b31f3f436682089008024af316ece0fc394e64fbda": {
    functionName: "createGiftCard_createServerFn_handler",
    importer: () => import("./wallet.functions-D5-Ga8us.mjs")
  },
  "dde7d1105dfe1a43ec26de193009fa4abab348c1264bd9da23c636530a2ced62": {
    functionName: "getAllGiftCards_createServerFn_handler",
    importer: () => import("./wallet.functions-D5-Ga8us.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C5_6oBDd.mjs").then((n) => n.w),
